...
def main() -> None:
    ...
    try:
        ...
        level = st.sidebar.radio(
            ...
            index=["National", "State", "Region", "Facility"].index(initial_level),
            key="level_selector"
        )
        ...
        try:
            ...
            # Add home button if on facility page - now both level and selected_value are defined
            if level == "Facility" and selected_value:
                st.markdown("""
            ...
            try:
                ...
                start_quarter = st.sidebar.selectbox(
                    "From",
                ...
                end_quarter = st.sidebar.selectbox(
                    "To",
